...
class EventSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $events = [
            // ACTIVE EVENTS
            [
                'name' => '🎯 Invite Competition - Win $500!',
                ...
                'winner_count' => 10,
                'prizes' => [
                    ['rank' => 1, 'description' => '🥇 Most Invites: $200', 'wallet_amount' => 200.00],
                    ['rank' => 2, 'description' => '🥈 2nd Place: $100', 'wallet_amount' => 100.00],
                    ['rank' => 3, 'description' => '🥉 3rd Place: $75', 'wallet_amount' => 75.00],
